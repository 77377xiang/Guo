 ...
 */
public abstract class Pull_Mark_releaseComplteRecyclerAdapter<T> extends RecyclerView.Adapter<RecycleHolder> {
    ...
    public Pull_Mark_releaseComplteRecyclerAdapter(Context mContext, List<T> mDatas, int mLayoutId) {
    ...
    public RecycleHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new RecycleHolder(mContext, mInflater.inflate(mLayoutId, parent, false));
    }
