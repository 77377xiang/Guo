package com.yude.judicialauctionproject.views.voice;
...
//				+ "/nickming_recorder_audios";
		...
		// 没有就去创建一个文件
			fpath = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/test_record/");
			fpath.mkdirs();
