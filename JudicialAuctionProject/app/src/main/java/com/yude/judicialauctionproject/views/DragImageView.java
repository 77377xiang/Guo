package com.yude.judicialauctionproject.views;
...
public class DragImageView extends ImageView {
    ...
    void onTouchMove(MotionEvent event) {
        ...
        if (mode == MODE.DRAG) {
            ...
            Double gapLenght = afterLenght - beforeLenght;// �仯�ĳ���
    ...
    double getDistance(MotionEvent event) {
        ...
        double yy = Double.parseDouble(String.valueOf(y)) ;
