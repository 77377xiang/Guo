 ...
 * 拍卖成功的详情界面
 */
public class SucceesDateilsActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void setOnItemClickListenerNoScrollListView() {
        directories_nss_LL.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                switch (i) {
                    case 0:
                        Toast.makeText(SucceesDateilsActivity.this, "竞买成功确认书", Toast.LENGTH_LONG).show();
                        startActivity(new Intent(SucceesDateilsActivity.this, DetailsBooksActivity.class));

                        break;
                    case 1:
                        startActivity(new Intent(SucceesDateilsActivity.this, DetailsExplainActivity.class));

                        Toast.makeText(SucceesDateilsActivity.this, "余款缴纳证明", Toast.LENGTH_LONG).show();

                        break;
                    case 2:
                        startActivity(new Intent(SucceesDateilsActivity.this, DetailsPlayListActivity.class));
                        Toast.makeText(SucceesDateilsActivity.this, "缴付清单", Toast.LENGTH_LONG).show();

                        break;
                    case 3:
                        startActivity(new Intent(SucceesDateilsActivity.this, DetailsNoticeActivity.class));

                        Toast.makeText(SucceesDateilsActivity.this, "竞买公告", Toast.LENGTH_LONG).show();

                        break;
                    case 4:
                        startActivity(new Intent(SucceesDateilsActivity.this, DetailsMustKnowActivity.class));
                        Toast.makeText(SucceesDateilsActivity.this, "竞买须知", Toast.LENGTH_LONG).show();

                        break;
                    case 5:
                        startActivity(new Intent(SucceesDateilsActivity.this, DetailsMarkBriefActivity.class));

                        Toast.makeText(SucceesDateilsActivity.this, "竞买标的物介绍", Toast.LENGTH_LONG).show();

                        break;
                    case 6:
                        Toast.makeText(SucceesDateilsActivity.this, "特殊消息", Toast.LENGTH_LONG).show();
                        Intent intent = new Intent(SucceesDateilsActivity.this, DetailsFavoriteNewActivity.class);
