package com.yude.judicialauctionproject.adapter.myadapter;
 ...
 */
public class List_ConcernAdapter  extends CommAdapter <Test>{


    public List_ConcernAdapter(List t, Context context) {
